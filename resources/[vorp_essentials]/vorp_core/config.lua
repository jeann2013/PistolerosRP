...
Config = {
  ...
  Langs = {
    ...
    wayPoint           = "PistolerosRP: ¡Primero tienes que fijar un punto de entrada!",
    mustBeSeated       = "PistolerosRP: ¡Debes estar en el asiento del conductor!",
    wagonInFront       = "PistolerosRP: ¡Debes estar sentado o cerca de un vagón para borrarlo!",
    cantCarry          = "PistolerosRP: ¡No se pueden llevar más armas!",
    Hold               = "¡¡ESPERA!!",
    Load               = "Está cargando en",
    Almost             = "Ya casi está...",
