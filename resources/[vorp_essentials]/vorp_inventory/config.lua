...
Config = {
  ...
  maxammo = { -- max ammo allowed to transfer between players
    AMMO_PISTOL = 25,
    AMMO_PISTOL_EXPRESS = 25,
    AMMO_PISTOL_EXPRESS_EXPLOSIVE = 25,
    AMMO_PISTOL_HIGH_VELOCITY = 25,
    AMMO_PISTOL_SPLIT_POINT = 25,
    AMMO_REPEATER = 25,
    AMMO_REPEATER_EXPRESS = 25,
    AMMO_REPEATER_EXPRESS_EXPLOSIVE = 100,
    AMMO_REPEATER_HIGH_VELOCITY = 100,
    AMMO_REPEATER_SPLIT_POINT = 100,
    AMMO_REVOLVER = 25,
    AMMO_REVOLVER_EXPRESS = 25,
    AMMO_REVOLVER_EXPRESS_EXPLOSIVE = 25,
    AMMO_REVOLVER_HIGH_VELOCITY = 25,
    AMMO_REVOLVER_SPLIT_POINT = 25,
    AMMO_RIFLE = 30,
    AMMO_RIFLE_ELEPHANT = 30,
    AMMO_RIFLE_EXPRESS = 30,
    AMMO_RIFLE_EXPRESS_EXPLOSIVE = 30,
    AMMO_RIFLE_HIGH_VELOCITY = 30,
    AMMO_RIFLE_SPLIT_POINT = 30,
    AMMO_22 = 25,
    AMMO_22_TRANQUILIZER = 25,
    AMMO_SHOTGUN = 30,
    AMMO_SHOTGUN_BUCKSHOT_INCENDIARY = 25,
    AMMO_SHOTGUN_EXPRESS_EXPLOSIVE = 25,
    AMMO_SHOTGUN_SLUG = 30,
    AMMO_ARROW = 10,
