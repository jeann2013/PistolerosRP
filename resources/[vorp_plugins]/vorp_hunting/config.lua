...
Config.SkinnableAnimals = {
    ...
    [-15687816381] = { name = "Big Horn Ram", givenItem = { "meat","provision_ram_hide","provision_ram_horn" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Carne", "Cuernos", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
...
Config.Animals = {
    ...
    [-15687816381] = { name = "Big Horn Ram", givenItem = { "meat","provision_ram_hide","provision_ram_horn" }, givenAmount = { 0 }, money = 6, gold = 0, rolPoints = 0, xp = 3, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1796037447, good = -476045512, perfect = 1795984405 },
    ...
    [90264823]     = { name = "Cougar", givenItem = { "meat","provision_cougar_claw","provision_cougar_fur" }, givenAmount = { 0 }, money = 35, gold = 0, rolPoints = 0, xp = 3, poorQualityMultiplier = 1.0, goodQualityMultiplier = 1.5, perfectQualityMultiplier = 2, poor = 1914602340, good = 459744337, perfect = -1791452194 },
