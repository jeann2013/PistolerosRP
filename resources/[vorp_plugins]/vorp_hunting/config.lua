...
Config.SkinnableAnimals = {
    ...
    [1110710183]  = { name = "Deer", givenItem = { "meat","provision_deer_hide" }, givenAmount = { 1,0 }, givenDisplay = {"Carne", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-1124266369] = { name = "Bear", givenItem = { "bearHeart", "bearClaws", "bear_skin" }, givenAmount = { 1, 3, 0 }, givenDisplay = { "Corazon", "Garras", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-1568716381] = { name = "Big Horn Ram", givenItem = { "meat","provision_ram_hide","provision_ram_horn" }, givenAmount = { 1, 0, 1 }, givenDisplay = { "Carne", "Cuernos", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [2028722809] = { name = "Boar", givenItem = { "meat","provision_boar_skin","provision_boar_tusk" }, givenAmount = { 1, 0, 1 }, givenDisplay = { "Carne", "Colmillo", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-1963605336] = { name = "Buck", givenItem = { "meat","provision_buck_antlers","provision_buck_fur" }, givenAmount = { 1, 1, 0 }, givenDisplay = { "Carne", "Cuernos", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [1556473961] = { name = "Bison", givenItem = { "meat","provision_bison_horn","provision_buffalo_fur" }, givenAmount = { 1, 1, 0 }, givenDisplay = { "Carne", "Cuernos", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [1957001316] = { name = "Bull", givenItem = { "meat","provision_bull_horns","provision_bull_hide" }, givenAmount = { 1, 1, 0 }, givenDisplay = { "Carne", "Cuernos", "Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    ...
    [-2021043433] = { name = "Elk", givenItem = { "meat","provision_elk_fur","provision_elk_antlers" }, givenAmount = { 1,0,1 }, givenDisplay = { "Carne", "Astas","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [252669332] = { name = "American Red Fox", givenItem = { "provision_fox_claw","provision_fox_fur" }, givenAmount = { 1,0 }, givenDisplay = { "Garras","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-1143398950] = { name = "Big Grey Wolf", givenItem = {  "meat","provision_trinket_wolf_heart","provision_wolf_fur" }, givenAmount = { 3,1,0 }, givenDisplay = { "Carne","Garras","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-885451903] = { name = "Medium Grey Wolf", givenItem = {  "meat","provision_trinket_wolf_heart","provision_wolf_fur" }, givenAmount = { 2,1,0 }, givenDisplay = { "Carne","Garras","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-829273561] = { name = "Small Grey Wolf", givenItem = {  "meat","provision_trinket_wolf_heart","provision_wolf_fur" }, givenAmount = { 1,1,0 }, givenDisplay = { "Carne","Garras","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    ...
    [-229688157] = { name = "Water Snake", givenItem = {  "meat","SnakeSkin" }, givenAmount = { 1,0 }, givenDisplay = { "Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-1790499186] = { name = "Snake Red Boa", givenItem = {  "meat","SnakeSkin" }, givenAmount = { 1,0 }, givenDisplay = { "Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [1464167925] = { name = "Snake Fer-De-Lance", givenItem = {  "meat","SnakeSkin" }, givenAmount = { 1,0 }, givenDisplay = { "Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [846659001] = { name = "Black-Tailed Rattlesnake", givenItem = {  "meat","SnakeSkin" }, givenAmount = { 1,0 }, givenDisplay = { "Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [545068538] = { name = "Western Rattlesnake", givenItem = {  "meat","SnakeSkin" }, givenAmount = { 1,0 }, givenDisplay = { "Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [-1211566332] = { name = "Striped Skunk", givenItem = {  "meat","provision_skunk_fur" }, givenAmount = { 1,0 }, givenDisplay = { "Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [40345436] = { name = "Merino Sheep", givenItem = { "meat","wool","provision_sheep_wool" }, givenAmount = { 1,1,0 }, givenDisplay = {"Lana", "Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    ...
    [-541762431] = { name = "Black-Tailed Jackrabbit", givenItem = {  "meat","provision_rabbit_pelt" }, givenAmount = { 1,0 }, givenDisplay = {"Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    [1755643085] = { name = "American Pronghorn Doe", givenItem = {  "meat","provision_pronghorn_fur","provision_pronghorn_horn" }, givenAmount = { 1,0,1 }, givenDisplay = {"Carne","Piel","Cuernos"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    ...
    [1007418994] = { name = "Berkshire Pig", givenItem = { "meat","provision_pig_skin" }, givenAmount = { 1,0 }, givenDisplay = {"Carne","Piel"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    ...
    [90264823] = { name = "Cougar", givenItem = {  "meat","provision_cougar_claw","provision_cougar_fur" }, givenAmount = { 1,2,0 }, givenDisplay = {"Carne","Piel","Garra"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    ...
    [480688259] = { name = "Coyote", givenItem = { "meat","provision_coyote_fang","provision_coyote_fur" }, givenAmount = { 1,1,0 }, givenDisplay = {"Carne","Piel","Colmillo"}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
