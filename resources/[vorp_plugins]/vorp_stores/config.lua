...
Config.Stores = {
    Valentine = {
        ...
        category = { "food", "tools", "fishing", "hunting", "lumberjack","drogas" }, -- you need to add the same words to the sellitems and buyitems category you can add new categories as long the items have the category names
    ...
    Armadillo = {
        ...
        AllowedJobs = {}, -- jobs allowed
        JobGrade = 0,
        category = { "food", "tools", "meds", "mining", "lumberjack","hunting","drogas","planting" },
        storeType = { "sell", "buy" },
        StoreHoursAllowed = false,
        RandomPrices = false,
        StoreOpen = 7, -- am
    ...
    StDenis = {
        ...
        AllowedJobs = {}, -- jobs allowed
        JobGrade = 0,
        category = { "food", "tools", "meds", "mining", "hunting","drogas" },
        storeType = { "sell", "buy" }, -- only one type
        StoreHoursAllowed = false,
        RandomPrices = false,
        StoreOpen = 7, -- am
    ...
    Vanhorn = {
        ...
        AllowedJobs = {}, -- jobs allowed
        JobGrade = 0,
        category = { "food", "tools", "fishing", "mining", "hunting","drogas" },
        storeType = { "sell", "buy" }, -- only one type
        StoreHoursAllowed = false,
        RandomPrices = false,
        StoreOpen = 7, -- am
    ...
    BlackwaterFishing = {
        ...
        AllowedJobs = {}, -- jobs allowed
        JobGrade = 0,
        category = { "bait", "tools", "fishing", "mining","hunting","drogas","planting" },
        storeType = { "sell", "buy" }, -- only one type
        StoreHoursAllowed = false,
        RandomPrices = false,
        StoreOpen = 7, -- am
    ...
    Wapiti = {
        ...
        AllowedJobs = {}, -- jobs allowed
        JobGrade = 0,
        category = { "food", "tools", "fishing", "lumberjack","hunting","drogas", "planting" },
        storeType = { "sell", "buy" }, -- only one type
        StoreHoursAllowed = false,
        RandomPrices = false,
        StoreOpen = 7, -- am
...
Config.SellItems = {
    Valentine = {
        ...
        { itemName = "provision_elk_antlers", itemLabel = "Cuernos alce grande", currencyType = "cash", sellprice = 1, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },        
        ...
        { itemName = "provision_pronghorn_horn", itemLabel = "Cuernos berrendo", currencyType = "cash", sellprice = 1.25, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
        ...
        -- { itemName = "provision_muskrat_fur", itemLabel = "Piel rata almiz.", currencyType = "cash", sellprice = 1.10, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },        
        { itemName = "provision_muskrat_scentgland", itemLabel = "Pulmon rata almiz.", currencyType = "cash", sellprice = 1.10, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
    ...
    Rhodes = {
        ...
        -- { itemName = "provision_moose_fur", itemLabel = "Piel de alce", currencyType = "cash", sellprice = 1.45, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
        -- { itemName = "provision_muskrat_fur", itemLabel = "Piel rata almiz.", currencyType = "cash", sellprice = 1.10, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },        
        { itemName = "provision_muskrat_scentgland", itemLabel = "Pulmon rata almizcle", currencyType = "cash", sellprice = 1.10, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
        -- { itemName = "provision_oxen_hide", itemLabel = "Piel de buey", currencyType = "cash", sellprice = 1.25, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
        { itemName = "provision_oxen_horn", itemLabel = "Cuernos de buey", currencyType = "cash", sellprice = 1.35, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
        { itemName = "provision_fox_claw", itemLabel = "Garra de zorro", currencyType = "cash", sellprice = 1.25, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
        -- { itemName = "provision_fox_fur", itemLabel = "Piel de zorro", currencyType = "cash", sellprice = 1.25, randomprice = math.random(25, 42), desc = "hunting", category = "hunting" },
...
Config.BuyItems = {
    Valentine = {
        ...
        { itemLabel = "Semilla de brocoli", itemName = "broccolisseed", currencyType = "cash", buyprice = 1, randomprice = 0.2, desc = "planting", category = "planting" },
        { itemLabel = "Semilla de trigo", itemName = "weatsseed", currencyType = "cash", buyprice = 1, randomprice = 0.2, desc = "planting", category = "planting" },
        { itemLabel = "Semilla de papa", itemName = "potatosseed", currencyType = "cash", buyprice = 1, randomprice = 0.2, desc = "planting", category = "planting" },
        { itemLabel = "Semilla de oregano", itemName = "oreganosseed", currencyType = "cash", buyprice = 1, randomprice = 0.2, desc = "planting", category = "planting" },
        { itemLabel = "Semilla de yuca", itemName = "yuccasseed", currencyType = "cash", buyprice = 1, randomprice = 0.2, desc = "planting", category = "planting" },
