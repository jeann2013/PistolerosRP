        ...
        while true do
            ...
            if inRobbery == true then
                ...
                if alldeath == true then
                    ...
                    npcs = {}
                    inRobbery = false
                TriggerEvent('vorp:ShowBasicTopNotification', "Todos los bandidos esta muertos.", 5000)
                break
                end
            end
        end
    end)
    TriggerEvent('vorp:ShowBasicTopNotification', "¡Te han tendido una emboscada!", 5000)
end
	...
	while true do
        ...
        if inRobbery == true then
            ...
            if IsPedDeadOrDying(PlayerPedId(),true) then
                TriggerEvent('vorp:ShowBasicTopNotification', "Te han robado.", 5000)
                for v,k in pairs(npcs) do
                    DeleteEntity(k)
                end
                npcs = {}
            ...
            if runAway == true then
                ...
                npcs = {}
                inRobbery = false
                TriggerEvent('vorp:ShowBasicTopNotification', "Lograste escapar.", 5000)
            end
        end
    end
end)
