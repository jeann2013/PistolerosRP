...
AddEventHandler("wcrp_robbery:startToRob", function(robtimer)
    ...
    if count >= 1 then
      --  playerjobloop()
        ...
        TriggerClientEvent("vorp:TipBottom", _source, "Has forzado con éxito la caja registradora", 6000)
       ...
       -- TriggerClientEvent('wcrp_robbery:startTimer', _source, robtimer)
        ...
        TriggerClientEvent("vorp:TipBottom", _source, "Usted no tiene una ganzúa", 6000)
    end     
end)
...
AddEventHandler("wcrp_robbery:payout", function()
    TriggerEvent('vorp:getCharacter', source, function(user)
      ...
      --  print('items being given : '..itemName)
        ...
        TriggerClientEvent("vorp:TipBottom", _source, 'Tienes $ '.. tostring(randommoney) .. ' y algunos items', 5000)
end)
