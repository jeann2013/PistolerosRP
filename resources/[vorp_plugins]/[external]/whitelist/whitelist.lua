...
AddEventHandler("playerConnecting", function(playerName, setKickReason, deferrals)
    ...
    deferrals.update("Por favor espera chequiando la WhiteList")
    ...
    for myIdx,identifier in pairs(GetPlayerIdentifiers(s)) do
        ...
        for wIdx,i in ipairs(whitelistArray) do
			...
			deferrals.update(string.format("Chequiando la whitelist: %.2f%%", (currentId / totalChecksNeeded)*100))
	...
	deferrals.done("No estas en la Whitelist")
end)
